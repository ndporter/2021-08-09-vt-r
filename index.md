...
address: Room 101S, Newman Library, Virginia Tech # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
longitude: "-80.410120"       # decimal longitude of the workshop venue (use https://www.latlong.net)
...
instructor: ["Nathaniel Porter", "Jesse Sadler", "Mariana Castaneda"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Cozette Comer"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://docs.google.com/document/d/1kF8fyZHArc8V6hHWutBRhKRweqMKJNHYqGI9hplWIWQ/edit?usp=sharing # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
---
...
<p>
  ...
  <strong>For this workshop, you will not need Bash, Git, or a Text Editor; you will only need Anaconda and the software included with it.</strong>
